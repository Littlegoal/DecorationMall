...
CREATE TABLE `commodity` (
  ...
  `commodity_type_id` int(10) unsigned NOT NULL COMMENT '商品类别id',
...
CREATE TABLE `commodity_attribute` (
  ...
  `commodity_attribute_id` int(10) unsigned NOT NULL COMMENT '商品属性id',
...
CREATE TABLE `commodity_attribute_type` (
  `commodity_attribute_type_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品属性类别id',
  `commodity_attribute_type_name` varchar(20) NOT NULL COMMENT '商品属性类别名称',
  `commodity_type_id` int(10) unsigned NOT NULL COMMENT '商品三级类别id',
...
CREATE TABLE `commodity_client` (
  `client_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '客户id',
...
CREATE TABLE `commodity_type_level_one` (
  `level_one_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '一级分类id',
...
CREATE TABLE `commodity_type_level_three` (
  `level_three_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '三级分类id',
  `level_three_name` varchar(100) NOT NULL COMMENT '三级分类名称',
  `level_two_id` int(10) unsigned NOT NULL COMMENT '二级分类id',
...
CREATE TABLE `commodity_type_level_two` (
  `level_two_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '二级分类id',
  `level_two_name` varchar(10) NOT NULL COMMENT '二级分类名称',
  `level_one_id` int(10) unsigned NOT NULL COMMENT '一级分类id',
...
CREATE TABLE `shop` (
  `shop_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '商家id',
